#!/usr/bin/env R
#Figure_4A_Supplemental_25.R


################################################################################
#This script is used to produce Figure 4A as well as Supplemental Figure 25.
#
#Run under R 3.6.1
...
saveFile <- paste(outDir, "Supplemental_25.pdf", sep="")
p <- ggplot(merged_regions_Table, aes(x=cCRE_dist)) + geom_density() + xlim(0,10000) + geom_vline(xintercept = 700, color="red")
ggsave(saveFile)
