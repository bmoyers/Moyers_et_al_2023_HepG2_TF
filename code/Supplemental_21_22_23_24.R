#!/usr/bin/env R
#Supplemental_21_22_23_24.R

################################################################################
#This script is used to produce Supplemental Figures 21, 22, 23, and 24
#
#Run under R 3.6.1
...
saveFile <- paste(outDir, "Supplemental_24.pdf", sep="")
...
saveFile <- paste(outDir, "Supplemental_21.png", sep="")
