#!/usr/bin/env R
#Figure_3B_SuppTable_4.R

################################################################################
#This script is used to produce Figure 3B as well as Supplemental Table 4.
#
#Run under R 4.1.0
...
saveFile <- paste(outDir, "Moyers_Figure3B_pvalTable.txt", sep="")
