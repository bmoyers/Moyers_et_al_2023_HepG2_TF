#!/usr/bin/env R
#Figure_3A_Supplemental_25.R

################################################################################
#This script is used to produce Figure 3A as well as Supplemental Figure 25.
#
#Run under R 3.6.1
...
saveFile <- paste(outDir, "Supplemental_25_table.txt", sep="")
