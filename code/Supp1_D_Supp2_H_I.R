...
saveFile <- paste(outDir, "Supplemental_Fig_S1D.pdf", sep="")
...
saveFile <- paste(outDir, "Supplemental_Fig_S2I.pdf", sep="")
...
saveFile <- paste(outDir, "Supplemental_Fig_S2H.pdf", sep="")
