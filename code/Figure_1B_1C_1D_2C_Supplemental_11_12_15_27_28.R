#!/usr/bin/env R
#Figure_1B_1C_1D_2C_Supplemental_11_12_15_27_28.R


################################################################################
#This script is used to produce Figures 1B, 1C, 1D, and 2C
#as well as Supplemental Figures 11, 12, 15, 27, and 28.
#
#Run under R 4.1.0
...
# the_info_table: Supplementary Table 5
...
for (i in 1:3) {
  ...
  saveFile <- paste(outDir, "Supplemental_28_rep", i, ".pdf", sep="")
...
for (i in 1:(length(element_rep_list)-1)) {
  for (j in (i+1):(length(element_rep_list))) {
    ...
    saveFile <- paste(outDir, "Supplemental_27_re", i, "_v_rep", j, "_bothRuns.pdf", sep="")
...
saveFile <- paste(outDir, "Supplemental_11.pdf", sep="")
...
saveFile <- paste(outDir, "Supplemental_15.pdf", sep="")
